...
namespace BCS.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //        //if (DuePassOnBill.Count > 0)
            //        //{
            //        //    foreach (var PassItems in DuePassOnBill)
            //        //    {
            //        //        searchCompany.CompanyList = db.Company.SqlQuery("SELECT * FROM Companies WHERE CompanyID = '" + PassItems.CompanyId + "'").ToList();
            //        //        if (searchCompany.CompanyList.Count == 1)
            //        //        {
            //        //            foreach (var PassItemss in searchCompany.CompanyList)
            //        //            {
            //        //                searchCompany.DueCompanyName.Add(PassItemss.CompanyName);
            //        //            }
            //        //        }
            //        //        searchCompany.DueBillingType.Add("Passed On Billing");
            //        //        searchCompany.DueEndDate.Add(PassItems.EndDate);
            //        //    }
            //        //}
            ...
            //    }
            //    return View("Index", searchCompany);
            //}
            //catch
            //{
