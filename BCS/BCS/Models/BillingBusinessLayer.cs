...
//{
//    public class BillingBusinessLayer
//    {
...
//        public BillingBusinessLayer(string GroupName, DateTime CoverageFrom, DateTime CoverageTo, DateTime BillingDate, DateTime BillingDue, int billingPeriodId, string userid, string fxRate, int generatePerCompanyId, string TypeOfBillingGenerate, string TypeOfBillingGenerateValue)
//        {
...
//                SearchCompanyPerGroup searchCompanyPerGroup = new SearchCompanyPerGroup(listOfCompanies, GroupName, CoverageFrom, CoverageTo, billingPeriodId, TypeOfBillingGenerate, generatePerCompanyId);
...
//                {
//                    if (PoleInformation.CompanyId == 6805)
//                    {
...
//                    var lastid = "0";
//                    IEnumerable<SubsidiaryLedger> ISub;
...
//                    if (ISub.Count() > 0)
//                        lastid = ISub.Max(m => m.BillingPeriod).ToString();
...
//                        var polePrincipalBalance = PolePrincipal.Balance("POLE RENTAL", PoleInformation.PoleInformationId.ToString(), PoleInformation.CompanyId, int.Parse(lastid));
//                        var polePrincipalInterest = polePrincipalBalance > 0 ? PoleInterest.Interest("POLE RENTAL", PoleInformation.CompanyId, PoleInformation.PoleInformationId.ToString(), CoverageFrom, BillingDate, polePrincipalBalance, polePrincipalBalance,lastid) : 0;
...
//                            var rentalPrincipalBalance = RentalPrincipal.Balance("RENTAL", rentalInformation.RentalInformationId.ToString(), rentalInformation.CompanyId, int.Parse(lastid));
//                            var rentalPrincipalInterest = rentalPrincipalBalance > 0 ? RentalInterest.Interest("RENTAL", rentalInformation.CompanyId, rentalInformation.RentalInformationId.ToString(), CoverageFrom, BillingDate, rentalPrincipalBalance, rentalPrincipalBalance,lastid) : 0;
...
//                    if (waterMeterAssignments.CompanyId == 5652 && waterMeterAssignments.MeterNumber == "14360")
//                    {
...
//                    var lastid = "0";
//                    IEnumerable<SubsidiaryLedger> ISub;
//                    ISub = db.SubsidiaryLedger.Where(k => k.CompanyId == waterMeterAssignments.CompanyId && k.BillingType == "WATER" && k.BillingReference == waterMeterAssignments.MeterNumber.ToString()).ToList();
...
//                    InterestWithBillingPeriod interestWithBillingPeriod = new InterestWithBillingPeriod();
...
//                    var waterInterest = _waterPrincipalBalance > 0 ? interestWithBillingPeriod.Interest("WATER", waterMeterAssignments.CompanyId, waterMeterAssignments.MeterNumber, CoverageFrom, BillingDate, _waterPrincipalBalance,lastid) : 0;
//                    var sewerageInterest = _seweragePrincipalBalance > 0 ? interestWithBillingPeriod.Interest("SEWERAGE", waterMeterAssignments.CompanyId, waterMeterAssignments.MeterNumber, CoverageFrom, BillingDate, _seweragePrincipalBalance, lastid) : 0;
...
//                    var lastid = "0";
//                    IEnumerable<SubsidiaryLedger> ISub;
//                    ISub = db.SubsidiaryLedger.Where(k => k.CompanyId == franchiseFeeInformation.CompanyId && k.BillingType == "FRANCHISE" && k.BillingReference == franchiseFeeInformation.FranchiseFeeInformationId.ToString()).ToList();
...
//                        var franchisePrincipalBalance = FranchisePrincipal.Balance("FRANCHISE", franchiseFeeInformation.FranchiseFeeInformationId.ToString(), franchiseFeeInformation.CompanyId, int.Parse(lastid));
//                        var franchisePrincipalInterest = franchisePrincipalBalance > 0 ? FranchiseInterest.Interest("FRANCHISE", franchiseFeeInformation.CompanyId, franchiseFeeInformation.FranchiseFeeInformationId.ToString(), CoverageFrom, BillingDate, franchisePrincipalBalance, franchisePrincipalBalance,lastid) : 0;
...
//                        var garbagePrincipalBalance = GarbagePrincipal.Balance("GARBAGE", garbageInformation.CompanyId, int.Parse(lastid));
//                        var garbagePrincipalInterest = garbagePrincipalBalance > 0 ? GarbageInterest.Interest("GARBAGE", garbageInformation.CompanyId, garbageInformation.GarbageInformationId.ToString(), CoverageFrom, BillingDate, garbagePrincipalBalance,lastid) : 0;
...
//                if ((TypeOfBillingGenerate.ToUpper() == "PERADMINFEE"))
//                {
//                    AdminFees = db.AdminFee.Where(m => m.BillingPeriodId == billingPeriodId).ToList();
//                    AdminFeeEnterpriseTypeBLL adminFeeEnterpriseTypeBLL = new AdminFeeEnterpriseTypeBLL(AdminFees, TypeOfBillingGenerateValue);
//                    AdminFees = adminFeeEnterpriseTypeBLL.AdminFeePerEnterprise();
//                }
//                else if (TypeOfBillingGenerate.ToUpper() == "PERCOMPANY")
//                {
...
//                }
//                else if (TypeOfBillingGenerate.ToUpper() == "PERENTERPRISE")
//                {
...
//                    else if (zoneType.ToUpper() == "PRIVATE ECONOMIC ZONE")
//                        AdminFeeAmount = 3750;
//                    else if (zoneNature.ToUpper() == "MANUFACTURING SEZ" || zoneNature.ToUpper() == "AGRO-INDUSTRIAL ECOZONE" || zoneNature.ToUpper() == "TOURISM SEZ")
//                        AdminFeeAmount = 3750;
//                    else
//                        AdminFeeAmount = 3750;
...
//                        var lastid = "0";
//                        IEnumerable<SubsidiaryLedger> ISub;
//                        ISub = db.SubsidiaryLedger.Where(k => k.CompanyId == CompanyId && k.BillingType == "ADMIN FEE" && k.BillingReference == item.Dev_Comp_Code && k.Other == item.Zone_Code).ToList();
